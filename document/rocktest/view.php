...
<body>
    <div class="container">
        ...
        <table style="margin-top: 38px;">
            ...
            <tr>
                <td colspan="7">Name &amp; Address of the employer for whom the examination was made:
                    <strong> <?php echo $row['employer_address']; ?></strong>
                </td>
                <td colspan="7">Address of the premises at which the examination was made:
                    <strong><?php echo $row['premises_address']; ?></strong>
                </td>
                <td colspan="5">
                    Status:<br>
                    <b>ND</b>-No Defect<br>
            ...
            <tr class="section-title">
                ...
                <td style="text-align: center;">
                    <p><strong>WLL</strong></p>
                    <p><strong>or</strong></p>
                    <p><strong>SWL</strong></p>
                </td>
            ...
            <tr>
                ...
                <td colspan="12" style="text-align: center;">
                    <strong> <?php echo $row['grease_condition']; ?></strong>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="5" style="text-align: center;"><strong>Result/OK or Defect of SGOCC</strong><br>
                    <strong>Required actions for each result is cleared below</strong>
                </td>
            ...
            <tr>
                <td colspan="8" style="text-align: center;">
                    <p><strong>Name &amp; Qualification of the person making the report:
                            <br /><?php echo $row['inspector']; ?></strong></p>
                ...
                <td colspan="9" style="text-align: center;">
                    <p><strong>Name of the person authenticating of this report: <br />
                            <?php echo $row['technical_manager']; ?></strong></p>
                    <p style="text-align: left; font-size: 9px;"><strong>Signature:</strong>
