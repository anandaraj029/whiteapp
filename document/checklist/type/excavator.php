    ...
    <div class="container">
	  ...
	  <div class="table-responsive">
            <table class="table table-bordered">
				...
				<tr>
                <td colspan="3" style="text-align: center;"><strong>INSPECTION CHECKLIST FOR EXCAVATOR</strong></td>
				</tr>
            <tr>
                <td style="width: 25%; text-align: center;"><strong>FRM.0601-2.1</strong></td>
