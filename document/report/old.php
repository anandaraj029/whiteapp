            ...
            <form method="POST" action="./view_report_fetch.php?viewid=">
                <div class="panel_s mtop20">
                    <div class="panel-body">
                        ...
                        <table style="border:2px solid black; width: 100%; height: 184px;">
                            <tbody>
                                <tr>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <table class="table items items-preview estimate-items-preview" style="border:2px solid #bbb; width: 100%;">
                                        <thead>
                                            <tr>
                                                <th align="center">#</th>
