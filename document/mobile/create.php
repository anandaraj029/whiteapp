                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-element py-30 mb-30">
                        ...
                        <div class="form-row mb-20">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="theme-input-style" placeholder="Sticker No" value="<?php echo $data['sticker_no'] ?? ''; ?>" name="sticker_no" readonly required>
                            </div>
                        </div>
                        ...
                        <div class="form-row mb-20">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control pl-1" placeholder="Type Your Name" value="<?php echo $data['customer_name'] ?? ''; ?>" name="customer_name" readonly required>
                                </div>
                            </div>
                        </div>
                        <!-- End Form Row -->
                        ...
                        <div class="form-row mb-20">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control pl-1" placeholder="Type Email Address" value="<?php echo $data['customer_email'] ?? ''; ?>" name="customer_email" readonly required>
                                </div>
                            </div>
                        </div>
                        <!-- End Form Row -->
                        ...
                        <div class="form-row mb-20">
                            ...
                            <div class="col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control pl-1" placeholder="Contact Number" value="<?php echo $data['customer_mobile'] ?? ''; ?>" name="customer_mobile" readonly required>
                                </div>
                            </div>
                        </div>
                        <!-- End Form Row -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="form-element py-30 mb-30">
                        ...
                        <div class="form-row mb-20">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="theme-input-style" placeholder="Enter JRN" name="jrn" value="<?php echo $data['jrn'] ?? ''; ?>" readonly required>
                            </div>
                        </div>
                        <!-- End Form -->
                    </div>
