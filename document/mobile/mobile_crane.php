...
<div class="col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="theme-input-style" placeholder="Enter Boom Length (m)" value="">
                    </div>
                    <div class="form-group">
                        <label class="font-14 bold mb-2">Boom Angle (°)</label>
                        <input type="text" class="theme-input-style" placeholder="Enter Boom Angle (°)" value="">
                    </div>
                    <div class="form-group">
                        <label class="font-14 bold mb-2">SWL/Test Weight</label>
                        <input type="text" class="theme-input-style" placeholder="Enter SWL/Test Weight" value="">
                    </div>
</div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="theme-input-style" placeholder="Enter Radius (m)" value="">
                    </div>
                    <!-- <div class="form-group">
                        <label class="font-14 bold mb-2">STANDARDS</label>
                        <input type="text" class="theme-input-style" placeholder="Enter STANDARDS" value="">
                    </div> -->
                    <div class="form-group">
                        <label class="font-14 bold mb-2">COMMENTS</label>
                        <input type="text" class="theme-input-style" placeholder="Enter Comments" value="">
                    </div>
</div>
            </div>
...
<div class="form-group">
  ...
  <input type="file" class="theme-input-style" accept="image/*" placeholder="Upload Image">
</div>
