                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-element py-30 mb-30">
                                <h4 class="font-20 mb-30">Horizontal Form With Icons</h4>
                                    ...
                                    <div class="form-row mb-20">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="password" class="form-control pl-1" placeholder="password">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End Form Row -->
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-element py-30 vertical-form mb-30">
                                <h4 class="font-20 mb-30">Vertical Form</h4>
                                ...
                                <form action="#" method="POST">
                                    ...
                                    <!-- Form Group -->
                                    <div class="form-group">
                                        <label class="font-14 bold mb-2">Your Email</label>
                                        <input type="email" class="theme-input-style" placeholder="Type Email Address">
                                    </div>
                                    <!-- End Form Group -->
                        ...
                        <div class="col-lg-6">
                            <!-- Base Horizontal Form With Icons -->
                            <div class="form-element py-30 vertical-form mb-30">
                                <h4 class="font-20 mb-30">Vertical Form With Icons</h4>
